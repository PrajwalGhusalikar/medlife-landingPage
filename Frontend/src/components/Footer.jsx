    ...
    <footer style={{ backgroundColor: "#333333" }}>
      <div className="w-screen mt-4 flex flex-col sm:flex-row justify-between sm:items-center p-4">
        ...
        <div className="sm:w-[900] grid grid-cols-4 sm:mx-5 text-start font-inder">
          <div className="text-sm text-white mx-2 p-1 hover:cursor-pointer hover:underline hover:font-semibold">
            Pre-sale FAQ’s
          </div>
          <div className="text-sm text-white mx-2 p-1 hover:cursor-pointer hover:underline hover:font-semibold">
            Services
          ...
          <div className="text-sm  text-white mx-2 sm:w-28 hover:cursor-pointer hover:underline hover:font-semibold">
            Submit a Ticket
          </div>
          <div className="text-sm text-white mx-2 p-1 hover:cursor-pointer hover:underline hover:font-semibold">
            Support
