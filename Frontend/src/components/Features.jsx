...
const Features = () => {
  return (
    <div>
      ...
      <div className="sm:w-11/12 mx-auto my-8 md:gap-3  grid sm:grid-cols-3 place-items-center">
        <div className="w-72 h-48  bg-emerald-50 p-2  m-2 rounded shadow-custom transition ease-in-out hover:-translate-y-1 hover:scale-110  hover:bg-emerald-100  duration-150 ">
        ...
        <div className="w-72 h-48  bg-emerald-50 p-2  m-2 rounded shadow-custom transition ease-in-out hover:-translate-y-1 hover:scale-110 hover:bg-emerald-100  duration-150 ">
          ...
          <div className="m-2 text-base mt-0">
